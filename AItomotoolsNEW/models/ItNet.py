...
import AItomotoolsNEW.CTtools.ct_geometry as ct

from AItomotoolsNEW.utils.parameter import Parameter
...
class ItNet(AItomomodel.AItomoModel):
    def __init__(
        self, geometry_parameters: ct.Geometry, model_parameters = None
    ):
    ...
    def forward(self, sino):
        ...
        for i in range(4):#range(self.model_parameters.n_iters):
